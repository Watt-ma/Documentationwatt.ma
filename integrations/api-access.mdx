---
title: "Access the Wattsc REST API"
sidebarTitle: "API Access"
description: "Authenticate to the Wattsc REST API with a Bearer token, run a sample curl request to fetch readings, and understand rate limits for your plan."
---
