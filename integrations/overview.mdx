---
title: "Integrate Wattsc with Your Tools"
sidebarTitle: "Overview"
description: "Connect Wattsc to your stack via REST API, webhooks, and CSV exports. SCADA and BMS connectors are on the roadmap for industrial integrations."
---

Wattsc is built to fit into your existing workflow. You can pull data into your own systems, receive real-time notifications when thresholds are breached, and export historical data for offline analysis. This page summarizes the integration options available today and what is coming next.

<CardGroup cols={2}>
  <Card title="API Access" icon="code" href="/integrations/api-access">
    Query readings, meters, and alerts programmatically using the Wattsc REST API.
  </Card>
...
- **SCADA/BMS**: Planned for large facilities that want Wattsc analytics layered on top of existing industrial control systems.