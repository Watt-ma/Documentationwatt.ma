...
<Note>
  API access is available starting with the **Production** plan. The **Starter** and **Startup** plans do not include API access. See the [Plans](/en/compte/forfaits) page to change your plan self-service.
</Note>
...
<Steps>
  <Step title="Check your plan">
    Make sure your account is on the Production or Enterprise plan. Go to **Billing \> My Plan** to verify.
  </Step>
