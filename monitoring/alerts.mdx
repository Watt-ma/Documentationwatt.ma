...
sidebarTitle: "Alerts"
description: "Create watt.ma alert rules for energy consumption thresholds, choose email or SMS notification channels, and manage quiet hours to avoid alert fatigue."
---
